...
navigator.geolocation.getCurrentPosition( async (position) => {
	...
	let url = "http://localhost:3000/weather/" + latitude + "/" + longitude
	try {
		await fetch(url)								
			...
			.then(result => {													
				...
				document.getElementById("description").innerHTML = "Description: <span class='weather_output'>" + result .weather[0].main + "</span>";
